...
<script type="text/javascript" src=fetch_notification.js></script>
...
$sql = "Select distinct report_id from notification";
...
<div class="block">
    ...
    <select id = "report_id" onchange="select_Notification()"> 
            <?php  
    ...
    <table class = "styled-table">
        <thead>
                <th> Report ID </th>
                <th> Patient Social Security Number </th>
