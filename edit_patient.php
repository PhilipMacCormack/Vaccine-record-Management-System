...
<script type="text/javascript" src=fetchpatient.js></script>
...
$sql = "Select distinct p_number from patient";
...
<div class="block">
    ...
    <select id = "patient" onchange="selectPatient()"> 
            <?php  
