...
<script type="text/javascript" src=fetchp_login.js></script>
...
$sql = "Select distinct p_number from p_login";
...
<div class="block">
    ...
    <select id = "patient" onchange="selectP_login()"> 
            <?php  
