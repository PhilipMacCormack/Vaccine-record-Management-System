...
<script type="text/javascript" src=fetchh_login.js></script>
...
<div class="container">
    <header class="w3-container w3-padding-8 w3-center w3-black" id="home">
        ...
        <p><b>Admin Tool</b></p>
        <p><b>Edit Healhcare worker login</b></p>
    </header>
</div>
...
$sql = "Select distinct employee_id from h_login";
...
<div class="block">
    ...
    <select id = "h_login" onchange="selectH_login()"> 
            <?php  
    ...
    <table class = "styled-table">
        <thead>
               <th> Employee ID </th>
                <th> Password </th>
                <th> Email </th>
                <th align="right"> Edit </th>> Edit </th>
        </thead>
        <tbody id="ans"> 
