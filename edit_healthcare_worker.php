...
<script type="text/javascript" src=fetchhealthcare_worker.js></script>
...
<div class="container">
    <header class="w3-container w3-padding-8 w3-center w3-black" id="home">
        ...
        <p><b>Admin Tool</b></p>
        <p><b>Edit Healthcare Workers</b></p>
    </header>
</div>
...
$sql = "Select distinct employee_id from healthcare_worker";
...
<div class="block">
    ...
    <select id = "healthcare_worker" onchange="selectHealthcare_worker()"> 
            <?php  
