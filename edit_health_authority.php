...
<script type="text/javascript" src=fetchhealth_authority.js></script>
...
$sql = "Select distinct ha_id from health_authority";
...
<div class="block">
    ...
    <select id = "health_authority" onchange="selectHealth_authority()"> 
            <?php  
            while( $rows = mysqli_fetch_array($res)){
                ?> 
                <option value="<?php echo $rows['ha_id'];  ?>"> <?php echo $rows['ha_id']; ?>  </option>
            <?php
            }
            ?>
 </select>
